...
//if(match[1] == '') return 
    ...
    else if (type === 'video') { await message.sendMessage(data, MessageType.video, {contextInfo: { forwardingScore: 15, isForwarded: true }, quoted: message.data}, { caption: "Made By LXR YOUTUBER" }) }
});
//const axios = require('axios')
